...
class RoborockDyadDataProtocol(RoborockEnum):
    ...
    DRY_COUNTDOWN = 237
    SET_CLEANSER_AMOUNT = 238
    AUTO_SMART_SELF_CLEAN_SET = 239
    LIGHT_SET = 240
    CLEAN_ASSIST_POWER_SET = 241
    SELF_CLEAN_WATER_TEMP_LEVEL_SET = 242
    DOCK_TYPE = 243
    WATER_MODE_SUCTION = 244
    WATER_MODE_BRUSH_SPEED = 245
    CHARGE_ERROR_STATUS = 246
    DRYING_RATE = 247
    FLAT_STATUS = 248
    POWERWHEEL_DIRECTION = 249
    POWERWHEEL_SPEED = 250
    ID_QUERY = 10000
    F_C = 10001
    SCHEDULE_TASK = 10002
    SND_SWITCH = 10003
